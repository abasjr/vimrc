# Generated by Abas. configuration wizard on 2022-02-20 at 17:23 WIB.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='abas@MacBook-Pro-M1-Max'

  # Don't show context unless running with privileges or in SSH.
  # Tip: Remove the next line to always show context.
  # Buat hidden username dan hostname
